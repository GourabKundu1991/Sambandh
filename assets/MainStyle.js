...
const MainStyle = StyleSheet.create({
    ...
    inputbox: { backgroundColor: lightColor, borderColor: greyColor, borderWidth: 1, borderRadius: 30, width: '100%', position: 'relative', overflow: 'hidden', padding: 5 },
    solidbtn: { height: 50, backgroundColor: baseColor, borderRadius: 30, overflow: 'hidden' },
    outlinebtn: { height: 43, borderColor: baseColor, borderWidth: 1, borderRadius: 30, overflow: 'hidden' },
