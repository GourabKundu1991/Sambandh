    ...
    const getAllData = () => {
        AsyncStorage.getItem('userToken').then(val => {
            if (val != null) {
                ...
                formdata.append("contentCode", "Terms-and-Conditions_19");
    ...
    return (
        <NativeBaseProvider>
            ...
            <VStack flex={1} backgroundColor={lightColor}>
                <HeaderComponents component={t("Terms & Conditions")} themeColor={orgDetails.color} navigation={navigation} />
                <ScrollView automaticallyAdjustKeyboardInsets={true}>
                    <VStack padding={5} space={5}>
                        <LinearGradient
                            colors={["#f0f2e5", "#ffffff"]}
                            flex={1}
                            style={{ borderRadius: 30, overflow: 'hidden', paddingLeft: 20, paddingRight: 30, paddingVertical: 20 }}
                        >
