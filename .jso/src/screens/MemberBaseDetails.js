  ...
  var MemberBaseDetailsScreen = function MemberBaseDetailsScreen(_ref) {
    ...
    var _React$useState3 = _react.default.useState([]),
      ...
      memberList = _React$useState4[0],
      setMemberList = _React$useState4[1];
    ...
    var getAllData = function getAllData() {
      _asyncStorage.default.getItem('userToken').then(function (val) {
        if (val != null) {
          ...
          fetch(`${_Config.BASE_URL}/get_dashboard_member_type_details`, {
            method: 'POST',
            headers: {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.NativeBaseProvider, {
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.StatusBar, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Header.default, {
          component: route.params.baseName,
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
            ...
            }), memberList.length == 0 && /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNativeLinearGradient.default, {
                ...
                children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
                  ...
                  children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.HStack, {
                    ...
                    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Text, {
                      ...
                      color: _MainStyle.darkGrey,
                      fontFamily: _MainStyle.fontBold,
                      children: [t("Dealer Code"), ":"]
                    }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                      fontSize: "sm",
                      color: _MainStyle.darkColor,
                      fontWeight: "bold",
                      children: item.dealer_code
                    })]
                    ...
                    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
                      ...
                      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                        ...
                        color: _MainStyle.darkColor,
                        fontFamily: _MainStyle.fontBold,
                        children: item.contacts_name
                      }), /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Text, {
                        fontSize: "sm",
                        color: _MainStyle.darkGrey,
                        fontFamily: _MainStyle.fontBold,
                        children: [t("Member ID"), ": ", item.id]
                      }), /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Text, {
                        fontSize: "sm",
                        color: _MainStyle.darkGrey,
                        fontFamily: _MainStyle.fontBold,
                        ...
                        onPress: function onPress() {
                          return Linking.openURL(`tel:${item.phone_number}`);
                        },
                        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.HStack, {
                          alignItems: 'center',
                          space: 2,
                    ...
                    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Text, {
                      ...
                      color: _MainStyle.darkColor,
                      fontWeight: "bold",
                      children: [item.available_point, " Points"]
                    })]
                  })]
                })
              }, index);
  ...
  var _default = exports.default = MemberBaseDetailsScreen;
