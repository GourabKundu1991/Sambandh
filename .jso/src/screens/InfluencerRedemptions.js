  ...
  var InfluencerRedemptionsScreen = function InfluencerRedemptionsScreen(_ref) {
    ...
    var getAllData = function getAllData(status) {
      _asyncStorage.default.getItem('userToken').then(function (val) {
        if (val != null) {
          ...
          fetch(`${_Config.BASE_URL}/my_influencer_redemption`, {
            method: 'POST',
            headers: {
            ...
            console.log("my_influencer_redemption:", responseJson);
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.NativeBaseProvider, {
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.StatusBar, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Header.default, {
          component: t("Approve Influencers"),
  ...
  var _default = exports.default = InfluencerRedemptionsScreen;
