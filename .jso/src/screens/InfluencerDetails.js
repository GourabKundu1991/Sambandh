  ...
  var InfluencerDetailsScreen = function InfluencerDetailsScreen(_ref) {
    var navigation = _ref.navigation,
      route = _ref.route;
    var _useWindowDimensions = (0, _reactNative.useWindowDimensions)(),
      width = _useWindowDimensions.width;
    var influencerId = route.params.influencerId;
    ...
    var _React$useState5 = _react.default.useState(""),
      ...
      profileData = _React$useState6[0],
      setProfileData = _React$useState6[1];
    ...
    var _React$useState9 = _react.default.useState(""),
      ...
      workingAddressData = _React$useState10[0],
      setWorkingAddressData = _React$useState10[1];
    var _React$useState11 = _react.default.useState(""),
      _React$useState12 = (0, _slicedToArray2.default)(_React$useState11, 2),
      profilePic = _React$useState12[0],
      setProfilePic = _React$useState12[1];
    ...
    var _React$useState13 = _react.default.useState(false),
      ...
      isDatePickerVisible = _React$useState14[0],
      setDatePickerVisibility = _React$useState14[1];
    var today = new Date();
    var _React$useState15 = _react.default.useState(""),
      _React$useState16 = (0, _slicedToArray2.default)(_React$useState15, 2),
      points = _React$useState16[0],
      setPoints = _React$useState16[1];
    var _React$useState17 = _react.default.useState(""),
      _React$useState18 = (0, _slicedToArray2.default)(_React$useState17, 2),
      userId = _React$useState18[0],
    ...
    var getAllData = function getAllData() {
      _asyncStorage.default.getItem('userToken').then(function (val) {
        if (val != null) {
          ...
          fetch(`${_Config.BASE_URL}/influncer_details`, {
            method: 'POST',
            headers: {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.NativeBaseProvider, {
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.StatusBar, {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Header.default, {
          component: t("Influencer Details"),
              ...
              children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
                ...
                children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.HStack, {
                  ...
                  children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                    ...
                    children: t("Influemcer ID")
                  }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                    fontSize: "md",
                    fontWeight: "bold",
                    color: orgDetails.name == "Zuari" ? _MainStyle.darkColor : _MainStyle.lightColor,
                    children: influencerId
                  })]
                }), [{
                  label: 'Name',
  ...
  var _default = exports.default = InfluencerDetailsScreen;
